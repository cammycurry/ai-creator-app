...
export type DownloadSettings = {
  deviceId: string;       // Device profile to inject
  quality: number;        // JPEG quality (80-100)
  stripMetadata: boolean; // Always true for safety, but user sees the toggle
  injectGps: boolean;     // Inject approximate GPS data
